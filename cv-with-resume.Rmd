...
tribble(
  ...
  2024, "Applied Epidemiological Methods 1", "Dartmouth College", "Teaching Assistant",
  2024, "Programming for Data Science", "Dartmouth College", "Teaching Assistant",
...
tribble(
  ~Year, ~Desc, ~Note,
  "2024", "Planned Use of Medication for Opioid Use Disorder Among Adolescents Entering Treatment for Opioid Use Disorder and Trends in the US, 2017-2021 ", "",
) %>%
  detailed_entries(Desc, glue::glue("{Year}"), Note)
```
...
tribble(
  ~Year, ~Desc, ~Note,
  "Fall 2024 present", "Volunteer at HIV/HCV Resource Center", "https://www.h2rc.org",
